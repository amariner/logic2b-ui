...
- 💡 Components beyond shadcn parity: tags input, autocomplete, rating,
  timeline, file dropzone, color picker, number field, code block with
  copy, native select. (Tree view and stepper shipped ✅.)
