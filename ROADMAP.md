...
- 💡 Components beyond shadcn parity: autocomplete, rating, timeline,
  file dropzone, color picker, number field, code block with copy, native
  select. (Tree view, stepper and tags input shipped ✅.)
