...
export const docsNav: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Static UI review", href: "/docs/review" },
      { title: "Incremental changes", href: "/docs/changes" },
      { title: "Consumer verification", href: "/docs/verification" },
...
export const docsNavEs: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Revisión estática de interfaces", href: "/es/docs/review" },
      { title: "Cambios incrementales", href: "/es/docs/changes" },
      { title: "Verificación en la aplicación", href: "/es/docs/verification" },
