...
Todavía no hay versión estable (`latest`); `1.0.0` será la primera. La beta es
el canal `next`, tanto para los paquetes npm como para el registro. Las
versiones siguientes son con las que se verificó esta documentación.
...
| Paquetes CLI y MCP local | `logic2b@next`, `@logic2b/mcp@next` (publicado `1.0.0-rc.2`) | Node.js 18+ con npm, pnpm, yarn o bun |
