...
export const GET: APIRoute = async ({ site }) => {
  ...
  const body = [
    ...
    `Curated, canonical presets are published at ${base}/themes/index.json;`,
    `each id opens visually at ${base}/create?preset=<id> and works unchanged`,
    "through CLI, MCP, VS Code and portable token exports.",
    "",
    "## Docs",
    "",
    ...guides.map(line),
    ...
    `- [Curated theme preset catalog](${base}/themes/index.json) — complete`,
    "  configs, canonical ids, studio links and measured audit notes.",
